...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.initializeApp = function () {
        ...
        this.platform.ready().then(function () {
            ...
            Object(rxjs_observable_timer__WEBPACK_IMPORTED_MODULE_11__["timer"])(3000).subscribe(function () { return _this.showSplash = false; });
            setTimeout(function () {
...
var HomePage = /** @class */ (function () {
    ...
    HomePage.prototype.ngOnInit = function () {
        var _this = this;
        this.loader.blockingLoaderAuth.subscribe(function (event) {
            _this.loadingBlock = event;
        });
        this.advertisementArray = [];
        this.currentPage = 0;
