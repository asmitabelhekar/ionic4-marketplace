...
var AdvertisementdetailPage = /** @class */ (function () {
    function AdvertisementdetailPage(activatedRoute, platform, networkServices, apiCall, networkService, callNumber, googlemaps, router, fileChooser, base64, actionSheetCtrl, socialSharing, nativeGeocoder, filePath, loader) {
    ...
    AdvertisementdetailPage.prototype.getDataUrl = function (img) {
        ...
        this.fileChooser.open().then(function (fileUri) {
            ...
            _this.filePath.resolveNativePath(img).then(function (filePath) {
                return _this.base64.encodeFile(filePath).then(function (base64String) {
